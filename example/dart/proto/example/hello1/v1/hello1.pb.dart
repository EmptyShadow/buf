...
class HelloRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HelloRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'example.hello1.v1'), createEmptyInstance: create)
    ..aOM<$0.Type>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'v', subBuilder: $0.Type.create)
  ...
  @$pb.TagNumber(1)
  $0.Type get v => $_getN(0);
  @$pb.TagNumber(1)
  set v($0.Type v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasV() => $_has(0);
  @$pb.TagNumber(1)
  void clearV() => clearField(1);
  @$pb.TagNumber(1)
  $0.Type ensureV() => $_ensure(0);
}

class HelloReply extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HelloReply', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'example.hello1.v1'), createEmptyInstance: create)
...
class HelloApi {
  ...
  HelloApi(this._client);

  $async.Future<HelloReply> hello($pb.ClientContext ctx, HelloRequest request) {
    var emptyResponse = HelloReply();
    return _client.invoke<HelloReply>(ctx, 'Hello', 'Hello', request, emptyResponse);
  }
}
