...
func (c *helloClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/example.hello1.v1.Hello/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Hello_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.hello1.v1.Hello/Hello",
	}
...
var _Hello_serviceDesc = grpc.ServiceDesc{
	ServiceName: "example.hello1.v1.Hello",
	...
	Metadata: "example/hello1/v1/hello1.proto",
}
